...
class UserInputValidation {
  ...
  static signUpInputValidation(req, res, next) {
    const {
      username, firstname, lastname, bio, image, email, password, password_confirmation
    } = req.body.user;
    ...
    const validation = new Validator({
      ...
      'min.firstname': 'This :attribute is too short. Min length is :min characters.',
      'min.lastname': 'This :attribute is too short. Min length is :min characters.',
      'max.firstname': 'This :attribute is too long. Max length is :max characters.',
      'max.lastname': 'This :attribute is too long. Max length is :max characters.',
      'regex.firstname': 'The :attribute you have entered contains invalid character(s).',
      'regex.lastname': 'The :attribute you have entered contains invalid character(s).',
